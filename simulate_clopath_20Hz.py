...
#========================================================================
    ...
    input_nrn = SpikeGeneratorGroup(1, indices1, input_times1*ms)
...
#========================================================================
    ...
    # plots = Plots()
    # plots._time_series(rec=rec, variables=['u', 'w_clopath', 'u_homeo'], indices=[range(3), range(6), range(3)])
