...
class BuildFigDF:
    ...
    def _dt_response(self, ):
        ...
        # iterate over combinations
        for key in idx_keys:
            figdf.at[key, 'trace_marker']='x'
            figdf.at[key, 'trace_color']=black
            figdf.at[key, 'trace_ecolor']=gray
            figdf.at[key, 'fig_hlines']=[1]
            figdf.at[key,'fig_vlines']=[0]
            
            print key[2]
            # # set trace marker
            # #------------------
            # if key[2][0]==-10:
            #     figdf.at[key, 'trace_marker']='.'
            #     figdf.at[key, 'trace_color']=red
            #     figdf.at[key, 'trace_ecolor']=red_light
            # if key[2][0]==10:
            #     figdf.at[key, 'trace_marker']='x'
            #     figdf.at[key, 'trace_color']=blue
            #     figdf.at[key, 'trace_ecolor']=blue_light
    ...
    def _frequency_response(self, ):
        ...
        # figdf['fig_xmax']=26.
        figdf['fig_ylabel']='Norm. weight (au)'
        figdf['fig_xlabel']='Input frequency (Hz)'
        # figdf['fig_dyticks']=.2
        # figdf['fig_dxticks']=20
        # # trace level parameters
        figdf['trace_ealpha']=1
    ...
    def _weight_hist(self, ):
        ...
        figdict = {
            ...
            'all_dendrite_20':{
                ...
                'all_dendrite_20':[
                    # trace
                    (-20, (6,7,8,9,10,11,12), 'apical_tuft'),
                    (0, (6,7,8,9,10,11,12), 'apical_tuft'),
                    (20, (6,7,8,9,10,11,12), 'apical_tuft'),
                ]
            },
            'all_dendrite_1':{
                ...
                'all_dendrite_1':[
                    # trace
                    (-1, (6,7,8,9,10,11,12), 'apical_tuft'),
                    (0, (6,7,8,9,10,11,12), 'apical_tuft'),
                    (1, (6,7,8,9,10,11,12), 'apical_tuft'),
                ]
            },
