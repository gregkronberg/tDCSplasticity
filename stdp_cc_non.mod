...
This mod file has been altered so that it does not actually produce any synaptic current.  This modification is made in the NETRECEIVE block by commenting out the conductance change that occurs when a NetStim object is received
