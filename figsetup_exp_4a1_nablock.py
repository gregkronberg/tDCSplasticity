...
class BuildFigDF:
    ...
    def _ltp_bar(self, ):
        ...
        figdict = {
            ...
            #     ],
            # },
            'weak_paired_unpaired_4-16':{
                # subgroup
                'Weak only':[
                    # trace
                    (0, '2', (4,5,6,8,10,12,16,), 1),
                    (20, '2', (4,5,6,8,10,12,16,), 1),
                    
                ],
                # subgroup
                'Weak+strong':[
                    # trace
                    (0, '2', (4,5,6,8,10,12,16,), 2),
                    (20, '2', (4,5,6,8,10,12,16,), 2),
                ],
            },
            # 'weak_paired_unpaired_4-20':{
            #     # subgroup
            #     'weak':[
            #         # trace
            #         (0, '2', (4,5,6,8,10,12,16,20), 1),
            #         (0, '2', (4,5,6,8,10,12,16,20), 2),
            #     ],
            #     # subgroup
            #     'strong':[
            #         # trace
            #         (20, '2', (4,5,6,8,10,12,16,20), 1),
            #         (20, '2', (4,5,6,8,10,12,16,20), 2),
            #     ],
            # },
            # 'weak_associativity_10-20':{
            #     # subgroup
            #     'strong':[
            #         # trace
            #         (0, '1', (10,12,16,20)),
        ...
        figdf.at['Weak only','sub_location']=0
        figdf.at['Weak+strong','sub_location']=3

        figdf.at['Weak only','xticks_minor_loc']=0.5
        figdf.at['Weak+strong','xticks_minor_loc']=3.5
        ...
        for key in idx_keys:
            ...
            if key[2][0]==0:
                ...
                # if key[2][1]=='1':
                #     # figdf.at[key, 'trace_location']=0
                #     figdf.at[key, 'trace_label']='strong'
                # else:
                #     # figdf.at[key, 'trace_location']=1
                #     figdf.at[key, 'trace_label']='weak'
            # anodal
            if key[2][0]>0:
    ...
    def _xcorr(self, ):
        ...
        figdf['fig_xlabel']='Time delay (ms)'
        # figdf['fig_dyticks']=.2
        figdf['fig_dxticks']=1
        # # trace level parameters
    ...
    def _wtrace_mean(self, ):
        ...
        figdict = {
            ...
            'weak_unpaired_20':{
                ...
                'weak':[
                    # trace
                    (0, '2', (4,5,6,8,10,12,16,), 1, ('apical_tuft', 'apical_trunk')),
                    (20,'2', (4,5,6,8,10,12,16,), 1, ('apical_tuft', 'apical_trunk')),
                    # (-20,'2', (4,5,6,8,), 1, ('apical_tuft', 'apical_trunk')),
                ],
            },
            'weak_paired_20':{
                'strong':[
                    # trace
                    (0, '2', (4,5,6,8,10,12,16,), 2, ('apical_tuft', 'apical_trunk')),
                    (20, '2', (4,5,6,8,10,12,16,), 2, ('apical_tuft', 'apical_trunk')),
                    # (-20, '2', (4,5,6,8), 2, ('apical_tuft', 'apical_trunk')),
                ],
            }
        }
