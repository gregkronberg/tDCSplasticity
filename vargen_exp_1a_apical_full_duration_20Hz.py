...
kwargs = {
'experiment':'exp_1a_apical_full_duration_20Hz',
...
#############################################################################
def _w_clopath(vtrace_df=vtrace_df, vargen_functions=vargen_functions):
...
w_clopath_df=_w_clopath()

# get dcs effect on final weights
#---------------------------------
def _get_dcs_effect_on_weights(w_clopath_df=w_clopath_df, ):
    variable='w_clopath_df'
...
w_clopath_df=_get_dcs_effect_on_weights()