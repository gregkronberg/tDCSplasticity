...
class BuildFigDF:
    ...
    def _wtrace_mean(self, ):
        ...
        figdf['fig_xmin']=0.
        # figdf['fig_xmax']=30.
        figdf['fig_ylabel']='Synaptic weight (au)'
        figdf['fig_xlabel']='Time (ms)'
        # figdf['fig_dyticks']=.2
        # figdf['fig_dxticks']=20
        # # trace level parameters
    ...
    def _trace_individual(self, trial_id=slice(None)):
        ...
        figdict = {
            ...
            'all_soma':{
                ...
                'all_soma':[
                    # trace
                    (-20, (6,8,10,12), 'soma', trial_id),
                    # (-5, ),
                    # (-1, ),
                    # (-0.5, ),
                    (0, (6,8,10,12), 'soma', trial_id),
                    # (0.5, ),
                    # (1, ),
                    # (5, ),
                    (20, (6,8,10,12), 'soma', trial_id),
            ...
            'all_dendrite':{
                ...
                'all_dendrite':[
                    # trace
                    (-20, (6,8,10,12), 'apical_tuft', trial_id),
                    # (-5, ),
                    # (-1, ),
                    # (-0.5, ),
                    (0, (6,8,10,12), 'apical_tuft', trial_id),
                    # (0.5, ),
                    # (1, ),
                    # (5, ),
                    (20, (6,8,10,12), 'apical_tuft', trial_id),
