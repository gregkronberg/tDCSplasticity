...
"""
import figsetup_exp_1a_apical_full_duration_20Hz as figsetup
import numpy as np
import analysis
import glob
import pickle
...
'''
'''
kwargs = {'experiment':'exp_1a_apical_full_duration_20Hz'}
dpi=350
...
def _vtrace_individual(vtrace_df=vtrace_df, figsetup=figsetup):
    # plot average voltage trace at soma and dendrite
    #------------------------------------------------
    trial_id = vtrace_df[(vtrace_df.path_1_syn_num==12)].trial_id.unique()[0]
